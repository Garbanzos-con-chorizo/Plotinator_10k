...
set output "C:/Projects/Plotinator_10k/outputs/2025-11-14_18-00-15/plot_Linear_Fit_Example/plot.png"
...
set grid back
set key top right
plot "C:/Projects/Plotinator_10k/outputs/2025-11-14_18-00-15/plot_Linear_Fit_Example/dataset_2/preprocessed.dat" using 1:2 with points title "Sample 1 (filtered)" pt 7 lc rgb "#ff7f0e", \
+     f(x) title sprintf("a*x + b") with lines lw 2.0 lc rgb "blue"
unset multiplot
unset output
