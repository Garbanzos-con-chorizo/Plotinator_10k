...
f(x) = A * exp(B * x)
fit f(x) "C:/Projects/Plotinator_10k/outputs/2025-11-14_17-07-51/plot_Exponential_Fit_Example/dataset_1/preprocessed.dat" using 1:2:4 via A,B
...
set output "C:/Projects/Plotinator_10k/outputs/2025-11-14_17-07-51/plot_Exponential_Fit_Example/plot.png"
...
set grid back
unset key
plot "C:/Projects/Plotinator_10k/outputs/2025-11-14_17-07-51/plot_Exponential_Fit_Example/dataset_1/preprocessed.dat" using 1:2 with points title "Growth Curve" pt 7 lc rgb "red", \
